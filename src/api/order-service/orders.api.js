...
export const fetchCheckout = async (payload) => {
  return await $http.get(`${BASE_URL}/user/checkout`, payload);
};
...
export const createCheckoutSession = async (payload) => {
  return await $http.post(`${BASE_URL}/create-checkout-session`, payload);
};
